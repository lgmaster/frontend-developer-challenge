(function () {
  ...
  const formNewsletter = document.querySelector(".newsletter__section form");
  ...
  const formShare = document.querySelector(".share__section form");

  formShare.addEventListener('submit', function (e) {
    e.preventDefault();

    const errors = validate(formShare, validateForm.configShare);
